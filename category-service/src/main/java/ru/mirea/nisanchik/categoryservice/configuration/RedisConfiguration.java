...
public class RedisConfiguration {
    ...
    public RedisCacheManager cacheManager(RedisConnectionFactory redisConnectionFactory) {
        RedisCacheConfiguration defaultCacheConfig = RedisCacheConfiguration.defaultCacheConfig()
                ...
                .computePrefixWith(cacheName -> "category-service:" + cacheName + ":")
                .disableCachingNullValues();

        Map<String, RedisCacheConfiguration> configs = new HashMap<>();
        //configs.put("category-pages", defaultCacheConfig.entryTtl(Duration.ofMinutes(5L)));
        configs.put("category-details", defaultCacheConfig.entryTtl(Duration.ofDays(1L)));
