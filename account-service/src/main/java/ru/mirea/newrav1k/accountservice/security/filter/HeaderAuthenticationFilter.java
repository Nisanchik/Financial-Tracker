package ru.mirea.newrav1k.accountservice.security.filter;
...
public class HeaderAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        String trackerId = request.getHeader("X-Tracker-Id");
        String trackerAuthorities = request.getHeader("X-Tracker-Authorities");
        if (trackerId != null && trackerAuthorities != null) {
            try {
                ...
                HeaderAuthenticationDetails headerAuthenticationToken =
                        new HeaderAuthenticationDetails(UUID.fromString(trackerId), authorities);
